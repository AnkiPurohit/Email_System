                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('email-templates.store') }}">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" onkeyup="listingslug(this.value)" />
                        </div>
                        <div class="form-group">
                            <label for="template_key">Template Key: *</label>
                            <input type="text" class="form-control" name="template_key" id="template_key" value="" />
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="editor" name="body" rows="4" cols="50"> </textarea>
                        </div>
